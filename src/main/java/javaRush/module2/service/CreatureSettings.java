...
public class CreatureSettings {
    public static String LINE = "_______________________________________________________________________________________________________________________________________________________________________";
    public static String ASTERICS_LINE = "***********************************************************************************************************************************************************************";
    public static Set<Class<? extends Creature>> CREATURE_SET = Collections.synchronizedSet(new HashSet<>(Set.of(
            Bear.class,
            Eagle.class,
            Fox.class,
            Snake.class,
    ...
    public static ConcurrentMap<Class<? extends Creature>,
            Map<Class<? extends Creature>, Integer>> PROBABILITY_TO_EAT = new ConcurrentHashMap<>();
...
//    public static int CATERPILLAR_MAX_ON_CELL = 1;
...
//    public static int COW_MAX_ON_CELL = 1;
...
//    public static int HARE_MAX_ON_CELL = 2;
...
//    public static int EAGLE_MAX_ON_CELL = 1;
